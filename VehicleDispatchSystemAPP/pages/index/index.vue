<template>
	<view class="content">
		...
		<view class="car-list">
			...
			<view class="car-item" v-for="(item, key) in vehicleModelList">
				...
				<view style="padding: 2rpx 10rpx 18rpx;">
					...
					<view class="bottom">
						...
						<view>
							<span class="price">日租￥{{item.minPrice}}起</span>
						</view>
					</view>
				</view>
			</view>
		...
		<loginPopUp :login="login" @getLogin="getLogin"></loginPopUp>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			changeCampus(idx){
				...
				if(this.area == '永川')
					this.vehicleModelList = this.yongchuan;
				else
					this.vehicleModelList = this.banan;
			},
